...
const TitleHeader = () => {
  ...
  return (
    ...
    >
        ...
        <Button handleClickToggleTheme={() => handleClickToggleTheme()}  icon={darkMode ? <IoSunnyOutline className="text-2xl text-gray-100 transition-all duration-1000 ease-in-out delay-300" /> : <IoMoonSharp className="text-2xl transition-all duration-1000 ease-in-out delay-300" style={{ color:'#1249'}} />}/>
    </div>
  )
}
