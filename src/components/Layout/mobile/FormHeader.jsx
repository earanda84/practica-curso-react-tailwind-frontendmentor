...
const FormHeader = ({todoCreate}) => {
  ...
  return (
    <div className="mb-5">
        <form 
          className="flex overflow-hidden bg-white rounded-md py-4 items-center gap-4 px-4 dark:bg-gray-800"
        ...
        >
            ...
            <input
                className="outline-none w-full text-gray-400 dark:bg-gray-800"
                type="text" 
